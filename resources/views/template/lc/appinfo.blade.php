...
<head>
    ...
    <link rel='stylesheet' href='/public/static/lc/css/down.css'/>
</head>
<body>
<script>(function () {
        var a = true;
        ...
        <div class="topbar">
            <div id="logo">
                <a href="{{config('webset.webdomin')}}">
                    <img src="/public/static/lc/images/logo.png" alt="{{config('webset.webname')}}-{{config('appconfig.appname')}}">
                </a>
            </div>
        </div>
...
<script type='text/javascript' src='/public/static/lc/js/down.js'></script>
